...
::: {.column width="70%"}
  ...
  * Дворкина Ева Владимировна, НКАбд-01-22
  * Студентка факультета физико-математических и естественных наук
  * Российский университет дружбы народов
  * 1132226447
  * <https://dvorkinaev.github.io/ru/>
...
![Просмотр содержимого каталога](image/7.png)

## Изучение файлов директории

Затем проверяю содержимое каталога с помощью утилиты ls.

![Перемещение между директориями и просмотр содержимого каталога](image/8.png)
## Создание директорий
